...
parser.add_argument('--WEIGHT_FILE', dest='WEIGHT_FILE', nargs='*', default='./experiments_lowlight/exp_58/checkpoint_ba8_test_blacknolowlight/yolov3_test_loss=12.4091.ckpt-68', help='folder of the training data')
...
cfg.filters = [ImprovedWhiteBalanceFilter,  GammaFilter,
    ToneFilter, GaussFilterDenoise, ContrastFilter, UsmFilter
]
...
cfg.min_kernel_size = 3
cfg.max_kernel_size = 3
...
__C.TEST.SCORE_THRESHOLD        = 0.3  # 判断目标检测框的分数，大于该阈值为可信
