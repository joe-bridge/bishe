...
#'/data/vdd/liuwenyu/data_vocfog/train/JPEGImages/'
    ...
    for i in range(10):
        ...
        img_name = '/home/jiahao/Downloads/Image-Adaptive-YOLO/data/data_vocdark/test/JPEGImages/' + image_name \
...
if __name__ == '__main__':
    an = load_annotations('/home/jiahao/Downloads/Image-Adaptive-YOLO/data/dataset_dark/voc_norm_train.txt')
    #an = load_annotations('/home/jiahao/Downloads/Image-Adaptive-YOLO/data/dataset_dark/voc_norm_test.txt')
    ll = len(an)
    print(ll)
    for j in range(ll):
