    ...
    with open(anno_path, 'a') as f:
        for image_ind in image_inds:
            ...
            for obj in objects:
                ...
                if obj.find('name').text.lower().strip() in \
                        ['bicycle', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'dog', 'motorbike', 'person']:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", default="/home/jiahao/Downloads/Image-Adaptive-YOLO/data/VOC/")
    parser.add_argument("--train_annotation", default="/home/jiahao/Downloads/Image-Adaptive-YOLO/data/dataset_dark/voc_norm_train.txt")
    parser.add_argument("--test_annotation",  default="/home/jiahao/Downloads/Image-Adaptive-YOLO/data/dataset_dark/voc_norm_test.txt")
